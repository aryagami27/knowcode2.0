    ...
    <div className=' bg-[#005918] overflow-x-hidden'>
      ...
      <div className='relative'>
        ...
        <img
          src='Theme.png'
          alt='Theme'
          className='absolute inset-0 m-auto z-10 w-[90%] max-w-[1000px]  sm:px-0 mt-2'
          style={{
            top: '50%',
            left: '50%',
      ...
      <div className="h-[50vh] w-full flex justify-center bg-leave bg-repeat pt-10">
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-white mt-1 bg-black px-1 bg-opacity-50'>AI/ML</p>
          </div>
          ...
          <p className='text-white mt-1 bg-black px-1 bg-opacity-50'>Frontend </p>
          </div>
          ...
          <p className='text-white mt-1 bg-black px-1 bg-opacity-50'>Cloud Native</p>
          </div>
          ...
          <p className='text-white mt-1 bg-black px-1 bg-opacity-50'>Data Science</p>
          </div>
          ...
          <p className='text-white mt-1 bg-black px-1 bg-opacity-50'>WEB3</p>
          </div>
          ...
          <p className='text-white mt-1 bg-black px-1 bg-opacity-50 text-xs'>CyberSecurity</p>
          </div>
          ...
          <p className='text-white mt-1 bg-black px-1 bg-opacity-50'>IOT</p>
          </div>
        </div>
      </div>
    </div>
